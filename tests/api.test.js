...
describe('API Endpoints', () => {
  ...
  test('POST /fetch should fetch and return original Yale content', async () => {
    ...
    expect(response.body.title).toBe('Yale University Test Page');
    expect(response.body.content).toContain('Welcome to Yale University');
    expect(response.body.content).toContain('https://www.yale.edu/about');  // URL should be present
    expect(response.body.content).toContain('>About Yale<');  // Link text should be unchanged
  });
